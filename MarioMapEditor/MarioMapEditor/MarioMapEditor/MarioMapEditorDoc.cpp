...
// MarioMapEditorDoc.cpp : implementation of the CMarioMapEditorDoc class
//
...
// CMarioMapEditorDoc construction/destruction
...
void CMarioMapEditorDoc::Serialize(CArchive& ar)
{
	if (ar.IsStoring())
	{
...
// CMarioMapEditorDoc diagnostics
